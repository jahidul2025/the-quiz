...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Add small delay to feel high quality
    setTimeout(() => {
    ...
    <div className="w-full max-w-md mx-auto px-4 py-12 md:py-24">
      <div className="glass-card rounded-2xl p-6 md:p-8 animate-pop-in relative overflow-hidden">
        ...
        <p className="text-slate-400 text-sm text-center mb-8">
          Sign up to track your scores and test your trivia skills.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="w-full py-3 bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-400 hover:to-indigo-500 text-white font-bold rounded-xl transition-all duration-300 shadow-md shadow-purple-600/20 transform hover:-translate-y-0.5 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
